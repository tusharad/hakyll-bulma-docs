...
const docSearchIndex = window.DOC_SEARCH_INDEX ?? [
    { title: "AWS reference architecture", summary: "Template landing page for AWS architecture docs.", url: "#architecture" },
    { title: "Key notes", summary: "Operational caveats and documentation notes.", url: "#notes" },
    { title: "Code sample", summary: "Example infrastructure code block.", url: "#references" }
];
